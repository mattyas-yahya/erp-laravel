...
<head>
    ...
    <title>
        {{ !empty($companySettings['header_text']) ? $companySettings['header_text']->value : config('app.name', 'ERPSolution SaaS') }}
        - {{ __('Career') }}</title>
...
{{--                     id="navbar-logo" style="height: 50px;">--}}
                <img class="hweb" alt="Image placeholder"
                     ...
                     id="navbar-logo" style="height: 100px;">
            </a>
        ...
        <div class="container">
            <div class="row row-grid justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="lead lh-180">{{ __('Job opening sub') }}</p>
            ...
            <div class="row align-items-center justify-content-md-between py-4 mt-4 delimiter-top">
                <div class="col-md-6">
                    <div class="copyright text-sm font-weight-bold text-center text-md-left">
                        {{ !empty($companySettings['footer_text']) ? $companySettings['footer_text']->value : 'ERPSolution SaaS' }}
                    </div>
                </div>
                <div class="col-md-6">
