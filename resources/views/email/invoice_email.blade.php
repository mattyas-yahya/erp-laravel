                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <h5 style="font-size: 38px; font-weight: 600; padding-bottom: 10px; line-height: normal;">
                                Hi, {{ $customerArr['invoice_name'] }}</h5>
                            <p>Welcome to {{ $app_name }}</p>
                            <p>Hope this email finds you well! Please see attached invoice number
                                <strong>{{ $customerArr['invoice_number'] }}</strong> for product/service.</p>
                            <p>Simply click on the button below: </p>
                            <p>{{ $customerArr['invoice_url'] }}</p>
                            <p>Feel free to reach out if you have any questions.</p>
                            <a href="{{ route('invoice.pdf', Crypt::encrypt($customerArr['invoiceId'])) }}"
                                target="_blank"
