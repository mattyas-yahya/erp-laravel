<div class="row">
    <div class="col-sm-12">
        <div class="mt-2">
            <div class="card">
                <div class="card-body">
                    {{ Form::open(['route' => ['production.report'], 'method' => 'GET', 'id' => 'production_report_filter']) }}
                            ...
                            <div class="row float-end">
                                <div class="col-auto mt-4">
                                    <a href="#" class="btn btn-sm btn-primary"
                                        onclick="document.getElementById('production_report_filter').submit(); return false;"
                                        data-bs-toggle="tooltip" title="{{ __('Apply Filter') }}"
                                        data-original-title="{{ __('Apply Filter') }}">
                                        <span class="btn-inner--icon"><i class="ti ti-search"></i></span>
                                    </a>

                                    <a href="{{ route('production.report') }}" class="btn btn-sm btn-danger "
