{{ Form::open(['route' => ['production.schedule.detail.update', ['id' => $schedule->id, 'detailId' => $scheduleDetail->id]], 'method' => 'PUT']) }}
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-lg-3 col-md-3">
            ...
            {{ Form::text('dimension_t', $scheduleDetail->dimension_t, ['class' => 'form-control']) }}
        </div>

        <div class="form-group col-lg-3 col-md-3">
            {{ Form::label('dimension_l', 'L', ['class' => 'form-label']) }} <span class="text-danger">*</span>
            {{ Form::text('dimension_l', $scheduleDetail->dimension_l, ['class' => 'form-control']) }}
        </div>

        <div class="form-group col-lg-3 col-md-3">
            {{ Form::label('dimension_p', 'P', ['class' => 'form-label']) }} <span class="text-danger">*</span>
            {{ Form::text('dimension_p', $scheduleDetail->dimension_p, ['class' => 'form-control']) }}
        </div>

        <div class="form-group col-lg-3 col-md-3">
            {{ Form::label('pieces', 'Total Pcs', ['class' => 'form-label']) }} <span class="text-danger">*</span>
            {{ Form::text('pieces', $scheduleDetail->pieces, ['class' => 'form-control', 'required']) }}
        </div>
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            {!! Form::text('production_total_text', $scheduleDetail->production_total, ['class' => 'form-control',  'readonly']) !!}
            {!! Form::hidden('production_total', $scheduleDetail->production_total) !!}
        ...
        <div class="form-group col-md-12">
            ...
            {!! Form::text('pack', $scheduleDetail->pack, ['class' => 'form-control']) !!}
        </div>
...
<div class="modal-footer">
    ...
    <input type="submit" value="{{ __('Update') }}" class="btn btn-primary schedule-detail-form-submit">
</div>
{{ Form::close() }}
...
<script>
    function setProductionTotal(payload) {
        ...
        console.log(productionScheduleDetail);
