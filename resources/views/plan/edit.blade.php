    ...
    <div class="row">
        ...
        <div class="form-group col-md-3">
            <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" name="enable_procurement" id="enable_procurement" {{ $plan['procurement'] == 1 ? 'checked="checked"' : '' }}>
                <label class="custom-control-label form-label" for="enable_procurement">{{__('Procurement')}}</label>
            </div>
        </div>
