                        ...
                        <div class="row ">
                            ...
                            <div class="col-6">
                                <ul class="list-unstyled my-5">
                                    ...
                                    <li class="white-sapce-nowrap"><span class="theme-avtar"><i class="text-primary ti ti-circle-plus"></i></span>{{($plan->procurement==1)?__('Enable'):__('Disable')}} {{__('Procurement')}}</li>
                                </ul>
                            </div>
                        </div>
