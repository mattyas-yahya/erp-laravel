...
@section('action-btn')
    <div class="float-end">
        @can('create award')
        <a href="#" data-size="lg" data-url="{{ route('award.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create New Award')}}" class="btn btn-sm btn-primary">
                    ...
                    <table class="table datatable">
                            ...
                            @foreach ($awards as $award)
                                <tr>
                                    ...
                                    <td>{{ !empty($award->branch())?$award->branch()->name:'' }}</td>
                                    <td>{{ !empty($award->department())?$award->department()->name:'' }}</td>
