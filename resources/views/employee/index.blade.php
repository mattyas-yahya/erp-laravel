...
@section('action-btn')
    <div class="float-end">
        <a href="{{ route('users.index') }}" data-bs-toggle="tooltip" title="{{ __('Create') }}"
            data-title="{{ __('Create New Indicator') }}" class="btn btn-sm btn-primary">
            <i class="ti ti-plus"></i>
        </a>
        {{-- <a href="{{ route('employee.create') }}"   data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create New Indicator')}}" class="btn btn-sm btn-primary">
            <i class="ti ti-plus"></i>
        </a> --}}
    </div>
@endsection
                            ...
                            <tbody>
                                @foreach ($employees as $employee)
                                    <tr>
                                        ...
                                        <td class="font-style">{{ $employee->relatedBranch->name ?? '-' }}</td>
                                        <td class="font-style">{{ $employee->relatedDepartement->name ?? '-' }}</td>
