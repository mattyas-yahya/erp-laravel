                            ...
                            <div class="preview-main client-preview">
                                <div data-v-f2a183a6="" class="d" id="boxes"
                                    ...
                                    <div data-v-f2a183a6="" class="d-body">
                                        ...
                                        <div data-v-f2a183a6="" style="margin-bottom: 5px;">
                                        ...
                                        <div data-v-f2a183a6="" class="d-bill-to">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table">
                                                <div data-v-f2a183a6="" class="d-table">
                                                    ...
                                                    <div class="d-table-body">
                                                        ...
                                                        <div class="d-table-tr"
                                                            ...
                                                            <div class="d-table-td w-4">
                                                                <pre
                                                                    data-v-f2a183a6="">{{ $item?->gr_from_so?->product_name }}</pre>
                                                            </div>
                                                            <div class="d-table-td w-3">
                                                                <pre
                                                                    data-v-f2a183a6="">{{ $item?->gr_from_so?->dimensions }}</pre>
                                                            </div>
                                                            <div class="d-table-td w-3">
                                                                <pre
                                                                    data-v-f2a183a6="">{{ $item?->gr_from_so?->weight }}</pre>
                                                            </div>
                                                            <div class="d-table-td w-6" style="text-align: right;">
                                                                <pre
                                                                    data-v-f2a183a6="">{{ Utility::priceFormat($settings, $item->sale_price) }}</pre>
                                                            </div>
                                                            <div class="d-table-td w-6" style="text-align: right;">
                                                                @if ($item?->gr_from_so?->unit()->name === 'Kg')
                                                                Rp{{ number_format($item->sale_price *
                                                                $item?->gr_from_so?->weight, 2, ',', '.') }}
                                                    ...
                                                    <div class="d-table-tr"
                                                        style="border-bottom:1px solid {{ $color }};">
                                                        <div class="d-table-td w-2 text-left">
                                                            Terbilang :
                                                        </div>
                                                        <div class="d-table-td w-11 text-left">
                                                            @php
                                                            ...
                                                            if ($x < 12) { return ' ' . $angka[$x]; } elseif ($x < 20) {
                                                                return terbilang($x - 10) . ' belas' ; } elseif ($x <
                                                                100) { return terbilang($x / 10) . ' puluh' .
                                                                terbilang($x % 10); } elseif ($x < 200) {
                                                                return 'seratus' . terbilang($x - 100); } elseif ($x <
                                                                1000) { return terbilang($x / 100) . ' ratus' .
                                                                terbilang($x % 100); } elseif ($x < 2000) {
                                                                return 'seribu' . terbilang($x - 1000); } elseif ($x <
                                                                1000000) { return terbilang($x / 1000) . ' ribu' .
                                                                terbilang($x % 1000); } elseif ($x < 1000000000) {
                                                                return terbilang($x / 1000000) . ' juta' . terbilang($x
                                                                % 1000000); } elseif ($x < 1000000000000) { return
                                                                terbilang($x / 1000000000) . ' milyar' . terbilang($x %
                                                                1000000000); } } @endphp {{ terbilang($invoice->
                                                                getTotal()) }} rupiah
                                                        </div>
                                                        <div class=" w-9 text-right">
                                                            <div class="d-table-tr">
                                                                ...
                                                                <div class=" w-12 text-right">
                                                                    <span>{{ Utility::priceFormat($settings,
                                                                        $invoice->getSubTotal()) }}
                                                                    </span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="d-table-tr">
                                                                ...
                                                                <div class=" w-12 text-right">
                                                                    <span>{{ Utility::priceFormat($settings,
                                                                        $invoice->getTotal()) }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class=" w-30 text-left" style="margin-top: 5px">
                                                        <div class="d-table-tr">
