                            ...
                            <tbody>
                                @foreach ($journalEntries as $journalEntry)
                                    <tr>
                                        ...
                                        <td>{{ $journalEntry->status_text }}</td>
                                        <td>
                                            @unless ($journalEntry->status === 'DONE')
                                                ...
                                                @endcan
                                            @endunless
                                            @if ($journalEntry->status === 'DONE')
                                                <div class="action-btn bg-primary ms-2">
                                                    <a data-title="{{ __('Show Journal') }}"
                                                        href="{{ route('journal-entry.show', [$journalEntry->id]) }}"
                                                        class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip"
                                                        title="{{ __('Show') }}"
