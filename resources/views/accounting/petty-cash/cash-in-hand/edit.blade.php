...
@section('content')
    {{ Form::model($cashInHand, ['route' => ['accounting.petty-cash.cash-in-hand.update', $cashInHand], 'class' => 'w-100']) }}
    <div class="row mt-4">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table mb-0 form-table" id="sortable-table">
                                    ...
                                    <td width="25%">
                                        <div class="form-group price-input">
                                            <input class="form-control cash-notes" data-nominal-value="{{ $nominal }}"
                                                ...
                                                type="number" min="0" value="{{ $cashInHandDetail->$key }}">
                                        </div>
                                    </td>
                                    <td class="text-end amount" data-amount-value="{{ $cashInHandDetail->$key * $nominal }}">
                                        {{ \Auth::user()->priceFormat($cashInHandDetail->$key * $nominal) }}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
                            <tr>
                                ...
                                <th class="text-end total">{{ \Auth::user()->priceFormat($cashInHand->getCashBalanceTotal()) }}</th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
