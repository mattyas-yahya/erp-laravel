                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($terminations as $termination)
                                <tr>
                                    ...
                                    @endrole
                                    <td>{{ !empty($termination->branch())?$termination->branch()->name:'' }}</td>
                                    <td>{{ !empty($termination->department())?$termination->department()->name:'' }}</td>
...
<script>
    $(document).on('change', 'select[name=branch_id]', function () {
        ...
        $("#department").html('');
        $.ajax({
            url: "{{url('termination/getdepartment/json')}}",
            type: "POST",
            data: {
                branch_id: idBranch,
                _token: '{{csrf_token()}}'
    ...
    $(document).on('change', '#department', function () {
        ...
        $("#employee").html('');
        $.ajax({
            url: "{{url('termination/getemployee/json')}}",
            type: "POST",
            data: {
