            ...
            <div class="card-body table-border-style">
                    ...
                    <table class="table datatable">
                            ...
                            @foreach ($announcements as $announcement)
                                <tr>
                                    <td>{{ !empty($announcement->branch())?$announcement->branch()->name:'ALL' }}</td>
                                    <td>{{ !empty($announcement->department())?$announcement->department()->name:'ALL' }}</td>
                                    <td>{{ ($announcement->employee())?$announcement->employee()->name:'ALL' }}</td>
