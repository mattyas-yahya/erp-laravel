                    ...
                    <table class="table datatable">
                            ...
                            @foreach ($meetings as $meeting)
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            $a = json_decode($meeting->department_id);                                            
                                        @endphp                                      
                                            @foreach($a as $su)
                                            @php
                                            $detail = App\Models\Department::find($su);
                                            @endphp
                                            @if($su === "0")
                                            <p>All</p>
                                            @else                                            
                                    ...
                                    <td>
                                        ...
                                        @php
                                            $a = json_decode($meeting->employee_id);                                            
                                        @endphp                                      
                                            @foreach($a as $su)
                                            @php
                                            $detail = App\Models\Employee::find($su);
                                            @endphp
                                            @if($su === "0")
                                            <p>All</p>
                                            @else                                            
        ...
        function getDepartment(bid) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#department_div").html('');
                    $('#department_div').append('<label for="department_id" class="form-label">{{ __('Department') }}</label>');
        ...
        function getEmployee(did) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#employee_div").html('');
                    $('#employee_div').append('<label for="employee_id" class="form-label">{{ __('Employee') }}</label>');
