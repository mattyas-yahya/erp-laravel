...
@section('content')
    ...
    {{Form::open(array('route'=>'loginProses','method'=>'post','id'=>'loginForm' ))}}
    @csrf
    <div class="">
        ...
        <p class="my-4 text-center">{{__("Don't have an account?")}} <a href="{{ route('register.show',!empty(\Auth::user()->lang)?\Auth::user()->lang:'en') }}" class="text-primary">{{__('Register')}}</a></p>
        <p class="text-center">Anda ingin demo? <a style="margin-top:-100px !important" type="button" class="text-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
            Klik Tautan Ini
         </a> </p>
