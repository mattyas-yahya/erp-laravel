    ...
    <div class="card-body">
        ...
        <div class="text-end">
            ...
            <a title="Mail Send" href="{{ route('payslip.send', [$employee->id, $payslip->salary_month]) }}"
                class="btn btn-sm btn-warning"><span class="ti ti-send"></span>{{ env('MAIL_FROM_ADDRESS') }}</a>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row text-sm">
                            <div class="col-md-6">
                                <address>
                                    <strong>{{ __('Name') }} :</strong> {{ $employee->name }}
                                    <br>
                                    <br>
                                    <strong>{{ __('Position') }} :</strong> {{ \Auth::user()->getDesignation($employee->designation_id)?->name }}
                                    <br>
                                    <br>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($payslipDetail['earning']['allowance'] as $allowance)
                                            ...
                                            <tr>
                                                ...
                                                @else
                                                    <td class="text-end">{{ $allowance->amount }}%
                                                        (${{ $empdallow }})</td>
                                                @endif
                                            </tr>
                                        @endforeach
                                        @foreach ($payslipDetail['earning']['commission'] as $commission)
                                            ...
                                            <tr>
                                                ...
                                                @else
                                                    <td class="text-end">{{ $commission->amount }}%
                                                        (${{ $empcomm }})</td>
                                                @endif
                                        ...
                                        @foreach ($payslipDetail['earning']['otherPayment'] as $otherPayment)
                                            ...
                                            <tr>
                                                ...
                                                @else
                                                    <td class="text-end">{{ $otherPayment->amount }}%
                                                        (${{ $emppayment }})</td>
                                                @endif
