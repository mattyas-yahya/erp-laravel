                        ...
                        <div class="card-body table-border-style full-card">
                            <div class="project-info d-flex text-sm">
                                ...
                                <div class="project-info-inner mr-3 col-6">
                                    ...
                                    <div class="project-amnt pt-1">@if(!empty($employee->salary)){{ \Auth::user()->priceFormat($employee->salary) }}@else -- @endif</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="card min-height-253">
                        ...
                        <div class="card-header ">
                            <div class="row">
                                <div class="col">
                                    <h6 class="mb-0">{{__('Fixed Allowance')}}</h6>
                                </div>
                                @can('create allowance')
                                    <div class="col text-end">
                                        <a href="#" data-url="{{ route('allowances.create',$employee->id) }}" data-size="md" data-ajax-popup="true" data-title="{{__('Create Fixed Allowance')}}" data-bs-toggle="tooltip"  title="{{__('Create')}}" data-original-title="{{__('Create Fixed Allowance')}}" class="apply-btn btn btn-sm btn-primary">
                                            <i class="ti ti-plus"></i>
                                        </a>
                                    </div>
                                @endcan
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach ($allowances as $allowance)
                                            <tr>
                                                ...
                                                @else
                                                    <td>{{($allowance->amount) }}% - ({{\Auth::user()->priceFormat($allowance->tota_allow)}})</td>
                                                @endif
                                                {{--                                        <td>{{  \Auth::user()->priceFormat($allowance->amount) }}</td>--}}
                                                <td class="">
                                                    @can('edit allowance')
