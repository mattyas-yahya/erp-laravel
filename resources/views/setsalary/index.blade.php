                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                @foreach ($employees as $employee)
                                    <tr>
                                        <td class="Id">
                                            <a href="{{ route('payroll.set-salary.show', $employee->id) }}"
                                        ...
                                        <td>{{ $employee->name }}</td>
                                        <td>{{ !empty($employee->relatedBranch) ? $employee->relatedBranch->name : '' }}</td>
                                        <td>{{ !empty($employee->relatedDepartement) ? $employee->relatedDepartement->name : '' }}
                                        </td>
