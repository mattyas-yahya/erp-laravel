    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="pills-account-tab" data-bs-toggle="pill" href="#procurement" role="tab"
                        aria-controls="pills-contact" aria-selected="false">{{ __('Procurement') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-account-tab" data-bs-toggle="pill" href="#marketing" role="tab"
                        aria-controls="pills-contact" aria-selected="false">{{ __('Marketing') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-account-tab" data-bs-toggle="pill" href="#warehouse" role="tab"
                        aria-controls="pills-contact" aria-selected="false">{{ __('Warehouse') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-account-tab" data-bs-toggle="pill" href="#production" role="tab"
                        aria-controls="pills-contact" aria-selected="false">{{ __('Production') }}</a>
                </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="procurement" role="tabpanel" aria-labelledby="pills-contact-tab">
                    @php
                        $modules = ['purchase request', 'purchase order', 'purchase approval', 'payment term'];
                    @endphp
                    <div class="col-md-12">
                        <div class="form-group">
                            @if (!empty($permissions))
                                <h6 class="my-3">{{ __('Assign Procurement related Permission to Roles') }}</h6>
                                <table class="table table-striped mb-0" id="">
                                    <thead>
                                        <tr>
                                            <th>
                                                <input type="checkbox"
                                                    class="form-check-input align-middle custom_align_middle"
                                                    name="procurement_checkall" id="procurement_checkall">
                                            </th>
                                            <th>{{ __('Module') }} </th>
                                            <th>{{ __('Permissions') }} </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($modules as $module)
                                            <tr>
                                                ...
                                                <td><input type="checkbox"
                                                        class="form-check-input align-middle ischeck procurement_checkall"
                                                        data-id="{{ str_replace(' ', '', $module) }}"></td>
                                                <td><label class="ischeck procurement_checkall"
                                                        data-id="{{ str_replace(' ', '', $module) }}">{{ ucfirst($module) }}</label>
                                                </td>
                                                <td>
                                                    ...
                                                    <div class="row ">
                                                        @if (in_array('view ' . $module, (array) $permissions))
                                                            @if ($key = array_search('view ' . $module, $permissions))
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    {{ Form::checkbox('permissions[]', $key, $role->permission, ['class' => 'form-check-input procurement_checkall isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key]) }}
                                                                    {{ Form::label('permission' . $key, 'View', ['class' => 'custom-control-label']) }}<br>
                                                                </div>
                                                            @endif
                                                        @endif
                ...
                <div class="tab-pane fade" id="marketing" role="tabpanel" aria-labelledby="pills-contact-tab">
                    @php
                        $modules = ['sales order'];
                    @endphp
                    <div class="col-md-12">
                        <div class="form-group">
                            @if (!empty($permissions))
                                <h6 class="my-3">{{ __('Assign Marketing related Permission to Roles') }}</h6>
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    <thead>
                                        <tr>
                                            <th>
                                                <input type="checkbox" class="form-check-input custom_align_middle"
                                                    name="marketing_checkall" id="marketing_checkall">
                                            </th>
                                            <th>{{ __('Module') }} </th>
                                            <th>{{ __('Permissions') }} </th>
                                        </tr>
                                                ...
                                                <td>
                                                    <div class="row ">
                                                        @if (in_array('view ' . $module, (array) $permissions))
                                                            @if ($key = array_search('view ' . $module, $permissions))
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    {{ Form::checkbox('permissions[]', $key, $role->permission, ['class' => 'form-check-input isscheck marketing_checkall isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key]) }}
                                                                    {{ Form::label('permission' . $key, 'View', ['class' => 'custom-control-label']) }}<br>
                                                                </div>
                                                            @endif
                                                        @endif
                ...
                <div class="tab-pane fade" id="warehouse" role="tabpanel" aria-labelledby="pills-contact-tab">
                    @php
                        $modules = ['goods receipt'];
                    @endphp
                    <div class="col-md-12">
                        <div class="form-group">
                            @if (!empty($permissions))
                                <h6 class="my-3">{{ __('Assign Warehouse related Permission to Roles') }}</h6>
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    <thead>
                                        <tr>
                                            <th>
                                                <input type="checkbox" class="form-check-input custom_align_middle"
                                                    name="warehouse_checkall" id="warehouse_checkall">
                                            </th>
                                            <th>{{ __('Module') }} </th>
                                            <th>{{ __('Permissions') }} </th>
                                        </tr>
                                                ...
                                                <td>
                                                    <div class="row ">
                                                        @if (in_array('view ' . $module, (array) $permissions))
                                                            @if ($key = array_search('view ' . $module, $permissions))
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    {{ Form::checkbox('permissions[]', $key, $role->permission, ['class' => 'form-check-input isscheck warehouse_checkall isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key]) }}
                                                                    {{ Form::label('permission' . $key, 'View', ['class' => 'custom-control-label']) }}<br>
                                                                </div>
                                                            @endif
                                                        @endif
                ...
                <div class="tab-pane fade" id="production" role="tabpanel" aria-labelledby="pills-contact-tab">
                    @php
                        $modules = [
                            'production',
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            @if (!empty($permissions))
                                <h6 class="my-3">{{ __('Assign Production related Permission to Roles') }}</h6>
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    <thead>
                                        <tr>
                                            <th>
                                                <input type="checkbox" class="form-check-input custom_align_middle"
                                                    name="production_checkall" id="production_checkall">
                                            </th>
                                            <th>{{ __('Module') }} </th>
                                            <th>{{ __('Permissions') }} </th>
                                        </tr>
                                                ...
                                                <td>
                                                    <div class="row ">
                                                        @if (in_array('manage ' . $module, (array) $permissions))
                                                            @if ($key = array_search('manage ' . $module, $permissions))
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    {{ Form::checkbox('permissions[]', $key, $role->permission, ['class' => 'form-check-input isscheck production_checkall isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key]) }}
                                                                    {{ Form::label('permission' . $key, 'Manage', ['class' => 'custom-control-label']) }}<br>
                                                                </div>
                                                            @endif
                                                        @endif
...
<script>
    $(document).ready(function() {
        ...
        $("#marketing_checkall").click(function() {
            $('.marketing_checkall').not(this).prop('checked', this.checked);
        });
        $("#warehouse_checkall").click(function() {
            $('.warehouse_checkall').not(this).prop('checked', this.checked);
        });
        $("#production_checkall").click(function() {
            $('.production_checkall').not(this).prop('checked', this.checked);
        });
