        ...
        <div class=" mt-2 " id="multiCollapseExample1">
            <div class="card">
                <div class="card-body">
                    ...
                    array('purchase-request.index'),'method'=>'get','id'=>'purchase_filter')) }}
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-btn bg-warning ms-2">
                                        <a href="#" data-url="{{ route('purchase-request.show',$item->id) }}" data-size="lg"
                                            data-bs-toggle="tooltip" title="{{__('Show')}}" data-ajax-popup="true"
                                            data-title="{{__('Show')}} - {{ $item->pr_number }}" class="mx-3 btn btn-sm align-items-center">
                                ...
                                <td>
                                    ...
                                    <div class="action-btn bg-danger ms-2">
                                        {!! Form::open(['method' => 'DELETE', 'route' => ['purchase-request.destroy',
