...
<head>
    <title>{{(Utility::getValByName('title_text')) ? Utility::getValByName('title_text') : config('app.name', 'ERPSolution')}} - @yield('page-title')</title>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.0/html5shiv.js"></script>
    <script src="https://unpkg.com/respond.min.js@1.4.2/respond.min.js"></script>
