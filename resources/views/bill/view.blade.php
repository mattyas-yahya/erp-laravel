                                        ...
                                        <table class="table">
                                            ...
                                            @foreach ($items as $key => $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $item?->productServiceUnit?->name }}</td>
                                                    <td>{{ $item->weight }}</td>
                                                    <td>{{ $item->qty ?? 0 }}</td>
                                                    ...
                                                    <td>Rp {{ number_format($item->discount ?? 0, 2, ',', '.') }}</td>
                                                    <td>Rp {{ number_format($item->price ?? 0, 2, ',', '.') }}</td>
                                                    <td class="text-end">Rp {{ number_format(($quantityAmount * $item->price), 2, ',', '.') }}</td>
                                                    <td>Rp {{ number_format($taxPpn, 2, ',', '.') }}</td>
                                                    <td>Rp {{ number_format($taxPph, 2, ',', '.') }}</td>
                                                    <td>Rp {{ number_format($item?->goodsReceiptDetail?->price_include, 2, ',', '.') }}</td>
                                                </tr>
                                            @endforeach
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td><b>Rp {{ number_format($totalDiscount ?? 0, 2, ',', '.') }}</b></td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        Rp {{ number_format($subTotal ?? 0, 2, ',', '.') }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="12"></td>
                                                    <td class="text-end"><b>{{ __('Tax') }}</b></td>
                                                    <td class="text-end">
                                                        Rp {{ number_format($totalTaxPrice ?? 0, 2, ',', '.') }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="12"></td>
                                                    <td class="text-end"><b>{{ __('Discount') }}</b></td>
                                                    <td class="text-end">
                                                        Rp {{ number_format($totalDiscount ?? 0, 2, ',', '.') }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="12"></td>
                                                    <td class="blue-text text-end"><b>{{ __('Total') }}</b></td>
                                                    <td class="blue-text text-end">
                                                        Rp {{ number_format($bill->getTotal(), 2, ',', '.') }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="12"></td>
                                                    <td class="text-end"><b>{{ __('Paid') }}</b></td>
                                                    <td class="text-end">
                                                        Rp {{ number_format($bill->getPaid(), 2, ',', '.') }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="12"></td>
                                                    ...
                                                    <td class="text-end">
                                                        Rp {{ number_format($bill->billTotalDebitNote() ?? 0, 2, ',', '.') }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="12"></td>
                                                    ...
                                                    <td class="text-end">
                                                        Rp {{ number_format($bill->getDue(), 2, ',', '.') }}
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
