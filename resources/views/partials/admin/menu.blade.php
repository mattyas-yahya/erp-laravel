...
<div class="navbar-wrapper">
    <div class="m-header main-logo">
        <a href="#" class="b-brand">
            <img src="{{ asset('assets/images/' . $logo) }}" alt="{{ env('APP_NAME') }}" class="logo logo-lg" />

            {{-- @if ($mode_setting['cust_darklayout'] && $mode_setting['cust_darklayout'] == 'on')
                    <img src="{{ $logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png') }}"
                        alt="{{ config('app.name', 'ERPSolution-SaaS') }}" class="logo logo-lg">
                    @else
        ...
        @if (\Auth::user()->type != 'client')
            <ul class="dash-navbar">
                ...
                @if (Gate::check('show hrm dashboard') ||
                        ...
                        Gate::check('manage production dashboard'))
                    <li
                        ...
                        <ul class="dash-submenu">
                                ...
                                <li
                                    ...
                                    <ul class="dash-submenu">
                                        ...
                                        @if (Gate::check('income report') ||
                                            ...
                                            <li
                                                class="dash-item dash-hasmenu {{ Request::segment(1) == 'report' ? 'active dash-trigger ' : '' }}">
                            ...
                            @if (\Auth::user()->show_hrm() == 1 && (Gate::check('show hrm dashboard') || Gate::check('manage report')))
                                <li
                            ...
                            @can('manage production dashboard')
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'dashboard.production' ? ' active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('dashboard.production') }}">{{ __('Production') }}</a>
                                </li>
                            @endcan

                            {{-- @can('manage production dashboard') --}}
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'dashboard.marketing' ? ' active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('dashboard.marketing') }}">{{ __('Marketing') }}</a>
                                </li>
                            {{-- @endcan --}}
                        </ul>
                    </li>
                                        ...
                                        <ul class="dash-submenu">
                                            @can('manage set salary')
                                                <li class="dash-item {{ request()->is('setsalary*') ? 'active' : '' }}">
                                                    <a class="dash-link"
                                                        href="{{ route('payroll.set-salary.index') }}">{{ __('Set salary') }}</a>
                                                </li>
                                            @endcan
                                            @can('manage pay slip')
                                            ...
                                            @can('manage set salary')
                                                <li
                                                    class="dash-item {{ request()->is('payroll/overtime*') ? 'active' : '' }}">
                                                    <a class="dash-link"
                                                        href="{{ route('payroll.overtime.staff.index') }}">{{ __('Overtime') }}</a>
                                                </li>
                                            @endcan
                                        </ul>
                                    </li>
                ...
                <!--------------------- Start Procurement System ----------------------------------->
                @if (\Auth::user()->show_procurement() == 1)
                    @canany([
                        'manage purchase request',
                        'manage purchase order',
                        'manage purchase approval',
                        'manage
                        goods receipt',
                        ])
                        <li
                            class="dash-item dash-hasmenu {{ Request::segment(1) == 'purchase-request' || Request::segment(1) == 'purchase-order' ? ' active dash-trigger' : '' }}">
                            <a href="#!" class="dash-link"><span class="dash-micon"><i
                                        class="ti ti-packages"></i></span><span
                                    class="dash-mtext">{{ __('Procurement') }}</span><span class="dash-arrow"><i
                                        data-feather="chevron-right"></i></span></a>
                            <ul
                                class="dash-submenu {{ Request::segment(1) == 'purchase-request' || Request::segment(1) == 'purchase-order' ? 'show' : '' }}">
                                @can('manage purchase request')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'purchase-request.index' || Request::route()->getName() == 'purchase-request.index_requisition' ? ' active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('purchase-request.index') }}">{{ __('Purchase Request') }}</a>
                                    </li>
                                @endcan

                                @can('manage purchase order')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'purchase-order.index' || Request::route()->getName() == 'purchase-order.index_detail' ? ' active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('purchase-order.index') }}">{{ __('Purchase Order') }}</a>
                                    </li>
                                @endcan

                                @can('manage purchase approval')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'purchase-approval.index' || Request::route()->getName() == 'purchase-approval.index' ? ' active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('purchase-approval.index') }}">{{ __('Approval') }}
                                            {{ __('Purchase order') }}</a>
                                    </li>
                                @endcan
                                ...
                                @can('manage purchase request')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'payment-term.index' || Request::route()->getName() == 'payment-term.index' ? ' active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('payment-term.index') }}">{{ __('Procurement Setting') }}</a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                ...
                @canany(['manage sales order'])
                    <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'sales-order' ? ' active dash-trigger' : '' }}">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-chart-bar"></i></span><span
                                class="dash-mtext">{{ __('Marketing') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu {{ Request::segment(1) == 'sales-order' ? 'show' : '' }}">
                            @can('manage sales order')
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'sales-order.index' || Request::route()->getName() == 'sales-order.index_detail' ? ' active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('sales-order.index') }}">{{ __('Sales Order') }}</a>
                                </li>
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'sales-order.history' ? ' active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('sales-order.history') }}">{{ __('Sales Order History') }}</a>
                                </li>
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'marketing.stock' ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('marketing.stock') }}">{{ __('Stock') }}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                ...
                <!--------------------- Start Warehouse ----------------------------------->
                @canany(['manage goods receipt', 'manage warehouse'])
                    <li
                        class="dash-item dash-hasmenu{{ Request::segment(1) == 'goods-receipt' || Request::segment(1) == 'warehouse' ? ' active dash-trigger' : '' }}">
                        <a href="#!" class="dash-link ">
                            <span class="dash-micon"><i class="ti ti-box"></i></span><span
                                class="dash-mtext">{{ __('Warehouse') }}</span><span class="dash-arrow">
                                <i data-feather="chevron-right"></i></span>
                        </a>
                        <ul class="dash-submenu {{ Request::segment(1) == 'goods-receipt' ? 'show' : '' }}">
                            @can('manage goods receipt')
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'goods-receipt.index' || Request::route()->getName() == 'goods-receipt.index_detail' ? ' active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('goods-receipt.index') }}">{{ __('Goods receipt') }}</a>
                                </li>
                            @endcan

                            @can('manage goods receipt')
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'goods-itemreceived.index' ? ' active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('goods-itemreceived.index') }}">{{ __('All Items Received') }}</a>
                                </li>
                            @endcan
                ...
                @if (\Auth::user()->show_pos() == 1)
                    @if (Gate::check('manage purchase') || Gate::check('manage pos') || Gate::check('manage print settings'))
                        <li
                            class="dash-item dash-hasmenu {{ Request::segment(1) == 'purchase' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' || Request::route()->getName() == 'pos.show' ? ' active dash-trigger' : '' }}">
                            <a href="#!" class="dash-link"><span class="dash-micon"><i
                                        class="ti ti-layers-difference"></i></span><span
                                    class="dash-mtext">{{ __('POS System') }}</span><span class="dash-arrow"><i
                                        data-feather="chevron-right"></i></span></a>
                            <ul
                                class="dash-submenu {{ Request::segment(1) == 'purchase' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' || Request::route()->getName() == 'pos.show' ? 'show' : '' }}">
                                @can('manage purchase')
                                    <li
                                ...
                                @can('manage pos')
                                    <li
                                        ...
                                        <a class="dash-link"
                                            href="{{ route('pos.index') }}">{{ __('Sales Order') }}</a>
                                    </li>
                ...
                @canany(['manage production'])
                    <li
                        class="dash-item dash-hasmenu {{ in_array(Request::route()->getName(), ['production.schedule.index', 'production.schedule.detail.index']) ? ' active dash-trigger' : '' }}">
                        <a href="#!" class="dash-link">
                            <span class="dash-micon">
                                <i class="ti ti-chart-area-line"></i>
                            </span><span class="dash-mtext">{{ __('Production') }}</span>
                            <span class="dash-arrow">
                                <i data-feather="chevron-right"></i>
                            </span>
                        </a>
                        <ul
                            class="dash-submenu {{ in_array(Request::route()->getName(), ['production.machine.index', 'production.machine.detail.index']) ? 'show' : '' }}">
                            @can('manage production')
                                <li
                                    class="dash-item {{ in_array(Request::route()->getName(), ['production.schedule.index', 'production.schedule.detail.index']) ? ' active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('production.schedule.index') }}">{{ __('Production Schedule') }}</a>
                                </li>
                            @endcan
                            @can('manage production')
                                <li
                                    class="dash-item {{ in_array(Request::route()->getName(), ['production.report']) ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('production.report') }}">{{ __('Report') }}</a>
                                </li>
                            @endcan
                            @can('manage production')
                                <li
                                    class="dash-item {{ in_array(Request::route()->getName(), ['production.machine.index', 'production.machine.detail.index']) ? ' active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('production.machine.index') }}">{{ __('Production Setting') }}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                    ...
                    @if (Gate::check('manage customer') ||
                        ...
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                @endif
                                @canany(['manage customer', 'manage proposal', 'manage invoice', 'manage revenue',
                                    'manage credit note'])
                                    <li
                                        ...
                                        <a class="dash-link" href="#">{{ __('Penjualan') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                            @can('manage customer')
                                                <li
                                            ...
                                            @endcan
                                            {{-- @can('manage giro monitoring') --}}
                                                <li
                                                    class="dash-item {{ Request::route()->getName() == 'accounting.sales.giro-monitoring.index' ? ' active' : '' }}">
                                                    <a class="dash-link"
                                                        href="{{ route('accounting.sales.giro-monitoring.index') }}">{{ __('Monitoring Giro') }}</a>
                                                </li>
                                            {{-- @endcan --}}
                                            {{-- @can('manage bill monitoring') --}}
                                                <li
                                                    class="dash-item {{ Request::route()->getName() == 'accounting.sales.bill-monitoring.index' ? ' active' : '' }}">
                                                    <a class="dash-link"
                                                        href="{{ route('accounting.sales.bill-monitoring.index') }}">{{ __('Monitoring Tagihan') }}</a>
                                                </li>
                                            {{-- @endcan --}}
                                        </ul>
                                    </li>
                                ...
                                @if (Gate::check('manage bill') || Gate::check('manage payment') || Gate::check('manage debit note'))
                                    <li
                                        ...
                                        <a class="dash-link" href="#">{{ __('Pembelian') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                ...
                                @if (Gate::check('manage chart of account') ||
                                    ...
                                    <li
                                        ...
                                        <a class="dash-link" href="#">{{ __('Pembukuan') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                            <li
                                ...
                                {{-- TODO: permission --}}
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'accounting.debt.index' ? ' active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('accounting.debt.index') }}">{{ __('Piutang') }}</a>
                                </li>
                                {{-- TODO: permission --}}
                                <li
                                    class="dash-item dash-hasmenu {{ Request::segment(1) == 'accounting' && Request::segment(2) == 'petty-cash' ? 'active dash-trigger' : '' }}">
                                    <a class="dash-link" href="#">{{ __('Petty Cash') }}<span
                                            class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                    <ul class="dash-submenu">
                                        <li
                                            class="dash-item {{ in_array(Request::route()->getName(), ['accounting.petty-cash.petty-cash.index', 'accounting.petty-cash.petty-cash.detail.index', 'accounting.petty-cash.petty-cash.detail.form']) ? ' active' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('accounting.petty-cash.petty-cash.index') }}">{{ __('Kas Kecil') }}</a>
                                        </li>
                                        <li
                                            class="dash-item {{ in_array(Request::route()->getName(), ['accounting.petty-cash.cash-in-hand.index', 'accounting.petty-cash.cash-in-hand.create', 'accounting.petty-cash.cash-in-hand.edit']) ? ' active' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('accounting.petty-cash.cash-in-hand.index') }}">{{ __('Uang Tunai') }}</a>
                                        </li>
                                        <li
                                            class="dash-item {{ in_array(Request::route()->getName(), ['accounting.petty-cash.report']) ? ' active' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('accounting.petty-cash.report') }}">{{ __('Laporan Kas Kecil') }}</a>
                                        </li>
                                    </ul>
                                </li>
                                <li
                                    class="dash-item dash-hasmenu {{ Request::segment(1) == 'accounting' && Request::segment(2) == 'treasury' ? 'active dash-trigger' : '' }}">
                                    <a class="dash-link" href="#">{{ __('Kas') }}<span
                                            class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                    <ul class="dash-submenu">
                                        <li
                                            class="dash-item {{ in_array(Request::route()->getName(), ['accounting.treasury.proof-of-cash.index']) ? ' active' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('accounting.treasury.proof-of-cash.index') }}">{{ __('Bukti Kas') }}</a>
                                        </li>
                                    </ul>
                                </li>
                ...
                <li
                    ...
                    <a href="#!" class="dash-link">
                        <span class="dash-micon">
                            <i class="ti ti-car"></i>
                        </span><span class="dash-mtext">{{ __('TMS') }}</span>
                        <span class="dash-arrow">
                            <i data-feather="chevron-right"></i>
                        </span>
                    </a>
                    <ul
                        ...
                        <li
                            class="dash-item {{ in_array(Request::route()->getName(), ['tms.assignment.index']) ? ' active' : '' }}">
                            <a class="dash-link"
                                href="{{ route('tms.assignment.index') }}">Riwayat Penugasan</a>
                        </li>
                        <li
                            class="dash-item {{ in_array(Request::route()->getName(), ['tms.delivery-schedule.index']) ? ' active' : '' }}">
                            <a class="dash-link"
                ...
                @canany(['manage report'])
                    <li
                        class="dash-item dash-hasmenu {{ in_array(Request::route()->getName(), ['report.marketing']) ? ' active dash-trigger' : '' }}">
                        <a href="#!" class="dash-link">
                            <span class="dash-micon">
                                <i class="ti ti-chart-area-line"></i>
                            </span><span class="dash-mtext">{{ __('Report') }}</span>
                            <span class="dash-arrow">
                                <i data-feather="chevron-right"></i>
                            </span>
                        </a>
                        <ul
                            class="dash-submenu {{ in_array(Request::route()->getName(), ['report.marketing']) ? 'show' : '' }}">
                            @can('manage report')
                                <li
                                    class="dash-item {{ in_array(Request::route()->getName(), ['report.marketing']) ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('report.marketing') }}">{{ __('Marketing') }}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                    ...
                    <li class="dash-item dash-hasmenu">
                        <a href="#!"
                            class="dash-link {{ Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'clients' ? ' active dash-trigger' : '' }}"><span
                                ...
                                class="dash-mtext">{{ __('User') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                            @can('manage user')
                                <li
