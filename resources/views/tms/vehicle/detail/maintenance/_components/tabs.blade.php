...
<div class="card" style="top:30px">
    <div class="list-group list-group-flush">
        <a href="{{ route('tms.vehicle.show.maintenance', ['id' => $vehicle->id, 'status' => 'submission']) }}"
            class="list-group-item list-group-item-action border-0 {{ Request::route()->getName() == 'tms.vehicle.show.maintenance' && Request::get('status') == 'submission' ? ' active' : '' }}">Pengajuan
