...
@section('content')
    <div class="p-3 card">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="tab-maintenance" role="tabpanel"
                aria-labelledby="pills-tab-maintenance">
                <div class="row p-4">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-12 px-4">
                                ...
                                {{ Form::model($vehicleMaintenance, ['route' => ['tms.vehicle.show.maintenance.update', $vehicle->id, $vehicleMaintenance->id], 'method' => 'PUT']) }}
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <select class="form-control select2" name="context_type" id="context_type" required>
                                            <option value=""> </option>
                                            <option value="INTERNAL" @if ($vehicleMaintenance->context_type == 'INTERNAL') selected @endif>
                                                Internal</option>
                                            <option value="EKSTERNAL" @if ($vehicleMaintenance->context_type == 'EKSTERNAL') selected @endif>
                                                Eksternal</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row form-data">
                                    @forelse ($vehicleMaintenanceDetails as $item)
                                        @include('tms.vehicle.detail.maintenance._components.form-row-detail')
                                    @empty
