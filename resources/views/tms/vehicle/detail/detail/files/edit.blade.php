{{ Form::model($vehicleFile, ['route' => ['tms.vehicle.show.detail.files.update', $vehicle->id, $vehicleFile->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
        ...
        <div class="form-group col-md-6">
            ...
            <div class="choose-file">
                <label for="file" class="form-label">
                    <input type="file" name="file" class="form-control" accept=".png, .jpg, .jpeg, .pdf, .docx, .xlsx">
                </label>
