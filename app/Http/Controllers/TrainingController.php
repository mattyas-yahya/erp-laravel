    ...
    public function index()
    {
        if(\Auth::user()->can('manage training'))
        {
            if(Auth::user()->type == 'company'){
                ...
                $trainings = Training::where('branch',Auth::user()->employee->branch_id)->where('created_by', '=', \Auth::user()->creatorId())->get();
                $status    = Training::$Status;
            }
    ...
    public function create()
    {
        if(\Auth::user()->can('create training'))
        {
            ...
            $branches      = Branch::where('created_by', \Auth::user()->creatorId())->get()->pluck('name', 'id');
                ...
                $branches      = Branch::where('id',Auth::user()->employee->branch_id)->where('created_by', \Auth::user()->creatorId())->get()->pluck('name', 'id');
            }
