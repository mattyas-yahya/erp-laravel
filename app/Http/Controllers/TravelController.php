...
class TravelController extends Controller
{
    public function index()
    {
        if(\Auth::user()->can('manage travel'))
        {
            ...
            {
                $travels = Travel::where('branch_id',Auth::user()->employee->branch_id)->where('created_by', '=', \Auth::user()->creatorId())->get();
            }
    ...
    public function create()
    {
        if(\Auth::user()->can('create travel'))
        {
            ...
            return view('travel.create', compact('branch'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('create travel'))
        {
            ...
            $travel                   = new Travel();
            $travel->branch_id     = $request->branch_id;
            $travel->department_id = $request->department_id;
    ...
    public function edit(Travel $travel)
    {
        ...
        if(\Auth::user()->can('edit travel'))
        {
            ...
            {
                return view('travel.edit', compact('travel', 'employees', 'branch', 'departments'));
            }
            else
            {
                return response()->json(['error' => __('Permission denied.')], 401);
