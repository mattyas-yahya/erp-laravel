...
class User extends Authenticatable
{
    ...
    public function priceFormat($price)
    {
        ...
        $currencySymbolPreText = $settings['site_currency_symbol_position'] == "pre"
            ? $settings['site_currency_symbol']
            : '';
        $currencySymbolPostText = $settings['site_currency_symbol_position'] == "post"
            ? $settings['site_currency_symbol']
            : '';

        return $currencySymbolPreText . ' ' . number_format($price, Utility::getValByName('decimal_number')) . $currencySymbolPostText;
    }
    ...
    public static function show_procurement()
    {
        $user_type = \Auth::user()->type;
        if ($user_type == 'company' || $user_type == 'super admin') {
            $user = User::where('id', \Auth::user()->id)->first();
        ...
        return !empty($user->plan) ? Plan::find($user->plan)->procurement : '';
    }
