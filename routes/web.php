...
use App\Http\Controllers\MarketingStockController;
use App\Http\Controllers\AccountingIncomeInvoiceController;
use App\Http\Controllers\SalesOrderHistoryController;
...
use App\Http\Controllers\ApiSalesOrderController;
use App\Http\Controllers\ReportMarketingController;
use App\Http\Controllers\AccountingDebtController;
use App\Http\Controllers\AccountingConfigPaymentMethodController;
...
Route::get('/register/{lang?}', [RegisteredUserController::class, 'showRegistrationForm'])->name('register.show');
Route::post('register', [RegisteredUserController::class, 'store'])->name('register');
Route::post('/dashboard', [DashboardController::class, 'store'])->name('dashboard.store');

Route::get('/suratjalangudang', function () {
    return view('goods_receipt.print_template.printview');
});
...
Route::post('/loginProses', [AuthenticatedSessionController::class, 'loginProses'])->name('loginProses');
...
Route::resource('chart-of-account-type', ChartOfAccountTypeController::class)->middleware(['auth', 'XSS', 'revalidate']);

Route::resource('chart-of-account-subtype', ChartOfAccountSubTypeController::class)->middleware(['auth', 'XSS', 'revalidate']);
...
Route::group(
    ...
    function () {
        ...
        Route::post('custom-credit-note', [CreditNoteController::class, 'customStore']);
        ...
        Route::post('invoice/{id}/credit-note', [CreditNoteController::class, 'store']);
        Route::get('invoice/{id}/credit-note/edit/{cn_id}', [CreditNoteController::class, 'edit'])->name('invoice.edit.credit.note');
        Route::post('invoice/{id}/credit-note/edit/{cn_id}', [CreditNoteController::class, 'update']);
...
Route::group(
    ...
    function () {
        ...
        Route::post('custom-debit-note', [DebitNoteController::class, 'customStore']);
        ...
        Route::post('bill/{id}/debit-note', [DebitNoteController::class, 'store']);
        Route::get('bill/{id}/debit-note/edit/{cn_id}', [DebitNoteController::class, 'edit'])->name('bill.edit.debit.note');
        Route::post('bill/{id}/debit-note/edit/{cn_id}', [DebitNoteController::class, 'update']);
...
Route::resource('revenue', RevenueController::class)->except([
    'index',
...
Route::group(
    ...
    function () {
        ...
        Route::post('bill/{id}/payment', [BillController::class, 'createPayment']);
        ...
        Route::resource('bill', BillController::class)->except([
            'index', 'create',
        ]);
...
Route::group(
    ...
    function () {
        ...
        Route::resource('proposal', ProposalController::class)->except([
            'create',
        ]);
    }
);
...
Route::prefix('/payroll')
    ...
    ->group(
        function () {
            Route::resource('set-salary', SetSalaryController::class);

            Route::prefix('/overtime')
                ->name('overtime.')
                ->group(
                    function () {
                        Route::resource('staff', PayrollStaffOvertimeController::class);
                        Route::resource('driver', PayrollDriverOvertimeController::class);
                    }
                );
        }
    );
...
Route::post('appraisal/getdepartment/json', [AppraisalController::class, 'getdepartment'])->name('appraisal.getdepartment.json')->middleware(['auth', 'XSS']);

Route::post('branch/employee/json', [EmployeeController::class, 'employeeJson'])->name('branch.employee.json')->middleware(['auth', 'XSS']);

Route::post('account-assets/getdepartment/json', [AssetController::class, 'getdepartment'])->name('account-assets.getdepartment')->middleware(['auth', 'XSS']);
Route::post('account-assets/getemployee/json', [AssetController::class, 'getemployee'])->name('account-assets.getemployee')->middleware(['auth', 'XSS']);
...
// HRM - HR Module
Route::post('resignation/getdepartment/json', [ResignationController::class, 'getdepartment'])->name('resignation.getdepartment')->middleware(['auth', 'XSS']);
Route::post('resignation/getemployee/json', [ResignationController::class, 'getemployee'])->name('resignation.getemployee')->middleware(['auth', 'XSS']);

Route::post('promotion/getdepartment/json', [PromotionController::class, 'getdepartment'])->name('promotion.getdepartment')->middleware(['auth', 'XSS']);
Route::post('promotion/getdesignation/json', [PromotionController::class, 'getdesignation'])->name('promotion.getdesignation')->middleware(['auth', 'XSS']);
Route::post('promotion/getemployee/json', [PromotionController::class, 'getemployee'])->name('promotion.getemployee')->middleware(['auth', 'XSS']);

Route::post('complaint/getdepartment/json', [ComplaintController::class, 'getdepartment'])->name('complaint.getdepartment')->middleware(['auth', 'XSS']);
Route::post('complaint/getemployee/json', [ComplaintController::class, 'getemployee'])->name('complaint.getemployee')->middleware(['auth', 'XSS']);

Route::post('warning/getdepartment/json', [WarningController::class, 'getdepartment'])->name('warning.getdepartment')->middleware(['auth', 'XSS']);
Route::post('warning/getemployee/json', [WarningController::class, 'getemployee'])->name('warning.getemployee')->middleware(['auth', 'XSS']);

Route::post('termination/getdepartment/json', [TerminationController::class, 'getdepartment'])->name('termination.getdepartment')->middleware(['auth', 'XSS']);
Route::post('termination/getemployee/json', [TerminationController::class, 'getemployee'])->name('termination.getemployee')->middleware(['auth', 'XSS']);

Route::post('travel/getdepartment/json', [TravelController::class, 'getdepartment'])->name('travel.getdepartment')->middleware(['auth', 'XSS']);
Route::post('travel/getemployee/json', [TravelController::class, 'getemployee'])->name('travel.getemployee')->middleware(['auth', 'XSS']);

Route::post('award/getdepartment/json', [AwardController::class, 'getdepartment'])->name('award.getdepartment')->middleware(['auth', 'XSS']);
Route::post('award/getemployee/json', [AwardController::class, 'getemployee'])->name('award.getemployee')->middleware(['auth', 'XSS']);

Route::post('holiday/getdepartment/json', [HolidayController::class, 'getdepartment'])->name('holiday.getdepartment')->middleware(['auth', 'XSS']);
...
Route::post('job-onboard/convert/{id}', [JobApplicationController::class, 'jobBoardConvertData'])->middleware(['auth', 'XSS']);
...
Route::resource('interview-schedule', InterviewScheduleController::class)->except([
    'create',
])->middleware(['auth', 'XSS']);
...
Route::post('transfer/getdepartment/json', [TransferController::class, 'getdepartment'])->name('transfer.getdepartment')->middleware(['auth', 'XSS']);
Route::post('transfer/getemployee/json', [TransferController::class, 'getemployee'])->name('transfer.getemployee')->middleware(['auth', 'XSS']);
...
Route::post('attendanceemployee/bulkattendance', [AttendanceEmployeeController::class, 'bulkAttendanceData'])->middleware(['auth', 'XSS']);
...
Route::post('attendanceemployee/attendance/update/{id}', [AttendanceEmployeeController::class, 'updateAttendance'])->name('attendanceemployee.updateAttendance')->middleware(['auth', 'XSS']);

Route::post('attendanceemployee/getdepartment/json', [AttendanceEmployeeController::class, 'getdepartment'])->name('attendanceemployee.getdepartment')->middleware(['auth', 'XSS']);
Route::post('attendanceemployee/getemployee/json', [AttendanceEmployeeController::class, 'getemployee'])->name('attendanceemployee.getemployee')->middleware(['auth', 'XSS']);

Route::post('leave/getdepartment/json', [LeaveController::class, 'getdepartment'])->name('leave.getdepartment')->middleware(['auth', 'XSS']);
Route::post('leave/getemployee/json', [LeaveController::class, 'getemployee'])->name('leave.getemployee')->middleware(['auth', 'XSS']);
...
Route::group(
    ...
    function () {
        ...
        Route::post('purchase/{id}/payment', [PurchaseController::class, 'createPayment']);
...
Route::get('/dashboard/production', [ProductionDashboardController::class, 'index'])->name('dashboard.production')->middleware(['auth', 'XSS', 'revalidate']);
Route::get('/dashboard/marketing', [DashboardMarketingController::class, 'index'])->name('dashboard.marketing')->middleware(['auth', 'XSS', 'revalidate']);


// ------------------------------------- Procurement System ------------------------------

// Purchase request
Route::controller(PurchaseRequestController::class)->middleware(['auth', 'XSS'])->group(function () {
    Route::get('purchase-request', 'index')->name('purchase-request.index');
    Route::get('purchase-request/create', 'create')->name('purchase-request.create');
    Route::post('purchase-request/store', 'store')->name('purchase-request.store');
    Route::get('purchase-request/{id}', 'show')->name('purchase-request.show');
    Route::get('purchase-request/{id}/edit', 'edit')->name('purchase-request.edit');
    Route::patch('purchase-request/{id}', 'update')->name('purchase-request.update');
    Route::delete('purchase-request/delete/{id}', 'destroy')->name('purchase-request.destroy');

    Route::get('purchase-request/requisition/{id}', 'index_requisition')->name('purchase-request.index_requisition');
    Route::get('purchase-request/requisition/{id}/create', 'create_requisition')->name('purchase-request.create_requisition');
    Route::post('purchase-request/requisition/store', 'store_requisition')->name('purchase-request.store_requisition');
    Route::delete('purchase-request/requisition/delete/{id}', 'destroy_requisition')->name('purchase-request.destroy_requisition');
    Route::post('purchase-request/getdepartmentsearch/json', 'getdepartmentsearch')->name('purchase-request.getdepartmentsearch');
    Route::post('purchase-request/getemployeesearch/json', 'getemployeesearch')->name('purchase-request.getemployeesearch');
    Route::post('purchase-request/getdepartment/json', 'getdepartment')->name('purchase-request.getdepartment');
    Route::post('purchase-request/getemployee/json', 'getemployee')->name('purchase-request.getemployee');
    Route::post('purchase-request/getproductservice/json', 'getproductservice')->name('purchase-request.getproductservice');
});
// Purchase order
Route::controller(PurchaseOrderController::class)->middleware(['auth', 'XSS'])->group(function () {
    Route::get('purchase-order', 'index')->name('purchase-order.index');
    Route::get('purchase-order/create', 'create')->name('purchase-order.create');
    Route::post('purchase-order/store', 'store')->name('purchase-order.store');
    Route::get('purchase-order/{id}', 'show')->name('purchase-order.show');
    Route::get('purchase-order/{id}/edit', 'edit')->name('purchase-order.edit');
    Route::patch('purchase-order/{id}', 'update')->name('purchase-order.update');
    Route::delete('purchase-order/delete/{id}', 'destroy')->name('purchase-order.destroy');

    Route::get('purchase-order/detail/{id}', 'index_detail')->name('purchase-order.index_detail');
    Route::get('purchase-order/detail/{id}/create', 'create_detail')->name('purchase-order.create_detail');
    Route::post('purchase-order/detail/store', 'store_detail')->name('purchase-order.store_detail');
    Route::get('purchase-order/detail/{id}/edit', 'edit_detail')->name('purchase-order.edit_detail');
    Route::patch('purchase-order/detail/{id}', 'update_detail')->name('purchase-order.update_detail');
    Route::delete('purchase-order/detail/delete/{id}', 'destroy_detail')->name('purchase-order.destroy_detail');
});
// approval
Route::controller(PurchaseApprovalController::class)->middleware(['auth', 'XSS'])->group(function () {
    Route::get('purchase-approval', 'index')->name('purchase-approval.index');
    Route::patch('purchase-approval/{id}', 'update')->name('purchase-approval.update');
    Route::get('purchase-approval/export', 'export')->name('purchase-approval.export');
});
// goods receipt
Route::controller(GoodsReceiptController::class)->middleware(['auth', 'XSS'])->group(function () {
    Route::get('goods-receipt', 'index')->name('goods-receipt.index');
    Route::get('goods-receipt/create', 'create')->name('goods-receipt.create');
    Route::post('goods-receipt/store', 'store')->name('goods-receipt.store');
    Route::get('goods-receipt/{id}', 'show')->name('goods-receipt.show');
    Route::get('goods-receipt/{id}/edit', 'edit')->name('goods-receipt.edit');
    Route::patch('goods-receipt/{id}', 'update')->name('goods-receipt.update');
    Route::delete('goods-receipt/delete/{id}', 'destroy')->name('goods-receipt.destroy');
    Route::get('goods-receipt/{id}/print', 'print')->name('goods-receipt.print');

    Route::get('goods-receipt/detail/{id}', 'index_detail')->name('goods-receipt.index_detail');
    Route::get('goods-receipt/detail/{id}/edit', 'edit_detail')->name('goods-receipt.edit_detail');
    Route::patch('goods-receipt/detail/{id}', 'update_detail')->name('goods-receipt.update_detail');
    Route::delete('goods-receipt/detail/delete/{id}', 'destroy_detail')->name('goods-receipt.destroy_detail');
    Route::delete('goods-receipt/detail/delete-bulk', 'destroyBulkDetail')->name('goods-receipt.destroy_bulk_detail');
    Route::post('goods-receipt/complete-header/{id}', 'completeHeader')->name('goods-receipt.complete-header');
});
// All Items Received
Route::controller(GoodsItemReceivedController::class)->middleware(['auth', 'XSS'])->group(function () {
    Route::get('goods-itemreceived', 'index')->name('goods-itemreceived.index');
    Route::get('goods-itemreceived/qrcode', 'generateQrCode')->name('goods-itemreceived.qrcode');
    Route::get('goods-itemreceived/pdf', 'generatePdf')->name('goods-itemreceived.generate-pdf');
});

Route::resource('uom', UomController::class)->middleware(['auth', 'XSS']);
Route::resource('payment-term', PaymentTermController::class)->middleware(['auth', 'XSS']);

// ------------------------------------- Marketing System ------------------------------

// sales order
Route::controller(SalesOrderController::class)->middleware(['auth', 'XSS'])->group(function () {
    Route::get('sales-order', 'index')->name('sales-order.index');
    Route::get('sales-order/history', [SalesOrderHistoryController::class, 'index'])->name('sales-order.history');

    Route::get('sales-order/create', 'create')->name('sales-order.create');
    Route::post('sales-order/store', 'store')->name('sales-order.store');
    Route::get('sales-order/{id}', 'show')->name('sales-order.show');
    Route::get('sales-order/{id}/edit', 'edit')->name('sales-order.edit');
    Route::patch('sales-order/{id}', 'update')->name('sales-order.update');
    Route::delete('sales-order/delete/{id}', 'destroy')->name('sales-order.destroy');

    Route::get('sales-order/detail/{id}', 'index_detail')->name('sales-order.index_detail');
    Route::get('sales-order/detail/{id}/create', 'create_detail')->name('sales-order.create_detail');
    Route::post('sales-order/detail/store', 'store_detail')->name('sales-order.store_detail');
    Route::get('sales-order/detail/{id}/edit', 'edit_detail')->name('sales-order.edit_detail');
    Route::patch('sales-order/detail/{id}', 'update_detail')->name('sales-order.update_detail');
    Route::delete('sales-order/detail/delete/{id}', 'destroy_detail')->name('sales-order.destroy_detail');
    Route::post('sales-order/getgrDetail/json', 'getgrDetail')->name('sales-order.getgrDetail');
});

Route::get('marketing/stock', [MarketingStockController::class, 'index'])->name('marketing.stock');
Route::get('marketing/stock/{id}/edit', [MarketingStockController::class, 'edit'])->name('marketing.stock.edit');
Route::put('marketing/stock/{id}', [MarketingStockController::class, 'update'])->name('marketing.stock.update');
Route::get('marketing/report/xls', [MarketingStockController::class, 'export'])->name('marketing.stock.generate-export-xls');
    ...
    ->group(
        function () {
            ...
            Route::prefix('/schedule')
                ->name('schedule.')
                ->controller(ProductionScheduleController::class)
                ->group(
                    function () {
                        Route::get('', 'index')->name('index');
                        Route::get('/create', 'create')->name('create');
                        Route::get('/pdf', 'generateMultiPdf')->name('generate-multi-pdf');
                        ...
                        Route::prefix('/{id}/detail')
                            ->name('detail.')
                            ->controller(ProductionScheduleDetailController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
                                    Route::get('/create', 'create')->name('create');
                                    Route::get('/{detailId}/edit', 'edit')->name('edit');

                                    Route::post('/', 'store')->name('store');
                                    Route::put('/{detailId}', 'update')->name('update');
                                    Route::delete('/{detailId}', 'destroy')->name('destroy');
                                }
                            );

                        Route::prefix('/{id}/production-remaining')
                            ->name('production-remaining.')
                            ->controller(ProductionScheduleRemainingController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
            ...
            // Production report
            Route::get('/report', [ProductionReportController::class, 'index'])->name('report');
            Route::get('/report/xls', [ProductionReportController::class, 'generateXls'])->name('report.generate-xls');

            // Machine (Master)
            Route::prefix('/machine')
                ->name('machine.')
                ->controller(ProductionMachineController::class)
                ->group(
                    function () {
                        Route::get('', 'index')->name('index');
                        Route::get('/create', 'create')->name('create');
    ...
    ->group(
        function () {
            ...
            Route::prefix('/vehicle')
                ->name('vehicle.')
                ->controller(\App\Http\Controllers\Tms\VehicleController::class)
                ->group(
                    function () {
                        Route::get('', 'index')->name('index');
                        Route::get('/create', 'create')->name('create');
            ...
            Route::prefix('/assignment')
                ->name('assignment.')
                ->controller(\App\Http\Controllers\Tms\AssignmentController::class)
                ->group(
                    function () {
                        Route::get('', 'index')->name('index');
                        Route::get('/create', 'create')->name('create');
                        ...
                        Route::prefix('/{id}/detail')
                            ->name('detail.')
                            ->controller(\App\Http\Controllers\Tms\AssignmentDetailController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
                                    Route::get('/create', 'create')->name('create');
            ...
            // Delivery Schedule
            Route::prefix('/delivery-schedule')
                ->name('delivery-schedule.')
                ->controller(\App\Http\Controllers\Tms\DeliveryScheduleController::class)
                ->group(
                    function () {
                        Route::get('', 'index')->name('index');
                        Route::get('/create', 'create')->name('create');
                ...
                ->group(
                    function () {
                        ...
                        Route::prefix('/ownership')
                            ->name('ownership.')
                            ->controller(\App\Http\Controllers\Tms\SettingOwnershipController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
                                    Route::get('/create', 'create')->name('create');
                        ...
                        // Master Kilometer
                        Route::prefix('/kilometer')
                            ->name('kilometer.')
                            ->controller(\App\Http\Controllers\Tms\SettingKilometerController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
                                    Route::get('/create', 'create')->name('create');
                        ...
                        // Master Pabrikan Kendaraan
                        Route::prefix('/vehicle-factory')
                            ->name('vehicle-factory.')
                            ->controller(\App\Http\Controllers\Tms\SettingVehicleFactoryController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
                                    Route::get('/create', 'create')->name('create');
                        ...
                        // Master Pabrikan Ban
                        Route::prefix('/tire-factory')
                            ->name('tire-factory.')
                            ->controller(\App\Http\Controllers\Tms\SettingTireFactoryController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
                                    Route::get('/create', 'create')->name('create');
...
Route::prefix('report')
    ...
    ->group(
        function () {
            Route::get('marketing', [ReportMarketingController::class, 'index'])->name('marketing');
            Route::get('marketing/export/excel', [ReportMarketingController::class, 'export_xls'])->name('marketing.export_xls');
            Route::get('marketing/export/pdf', [ReportMarketingController::class, 'export_pdf'])->name('marketing.export_pdf');
        }
    );
...
Route::group(
    ...
    function () {
        ...
        Route::post('invoice/{id}/payment', [InvoiceController::class, 'createPayment']);
    ...
    ->group(
        function () {
            ...
            Route::prefix('/sales')
                ...
                ->group(
                    function () {
                        Route::prefix('/giro-monitoring')
                            ->name('giro-monitoring.')
                            ->controller(\App\Http\Controllers\Accounting\Sales\GiroMonitoringController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
                                }
                        ...
                        Route::prefix('/bill-monitoring')
                            ->name('bill-monitoring.')
                            ->controller(\App\Http\Controllers\Accounting\Sales\BillMonitoringController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
                                }
            ...
            Route::prefix('/debt')
                ->name('debt.')
                ->controller(AccountingDebtController::class)
                ->group(
                    function () {
                        Route::get('', 'index')->name('index');
                    }
            ...
            Route::prefix('/petty-cash')
                ...
                ->group(
                    function () {
                        ...
                        Route::prefix('/petty-cash')
                            ->name('petty-cash.')
                            ->controller(\App\Http\Controllers\Accounting\PettyCash\PettyCashController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
                                    Route::get('/create', 'create')->name('create');
                                    ...
                                    Route::get('/{id}/edit', 'edit')->name('edit');
                                    Route::post('/', 'store')->name('store');
                                    Route::post('/{id}', 'duplicate')->name('duplicate');
                                    Route::put('/{id}', 'update')->name('update');
                                    Route::delete('/{id}', 'destroy')->name('destroy');

                                    Route::prefix('/{id}/detail')
                                        ->name('detail.')
                                        ->controller(\App\Http\Controllers\Accounting\PettyCash\PettyCashDetailController::class)
                                        ->group(
                                            function () {
                                                Route::get('', 'index')->name('index');
                        ...
                        Route::prefix('/cash-in-hand')
                            ->name('cash-in-hand.')
                            ->controller(\App\Http\Controllers\Accounting\PettyCash\CashInHandController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
                                    Route::get('/create', 'create')->name('create');
                                    ...
                                    Route::prefix('/{id}/detail')
                                        ->name('detail.')
                                        ->controller(\App\Http\Controllers\Accounting\PettyCash\CashInHandDetailController::class)
                                        ->group(
                                            function () {
                                                Route::get('', 'index')->name('index');
                                                Route::get('/form', 'form')->name('form');
                        ...
                        Route::get('/report', [\App\Http\Controllers\Accounting\PettyCash\ReportController::class, 'index'])->name('report');
                    }
                );

            // Kas
            Route::prefix('/treasury')
                ->name('treasury.')
                ->group(
                    function () {
                        Route::prefix('/proof-of-cash')
                            ->name('proof-of-cash.')
                            ->controller(\App\Http\Controllers\Accounting\Treasury\ProofOfCashController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
                                }
                ...
                ->group(
                    function () {
                        Route::prefix('/payment-method')
                            ->name('payment-method.')
                            ->controller(AccountingConfigPaymentMethodController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
                                    Route::get('/create', 'create')->name('create');
                        ...
                        Route::prefix('/payment-type')
                            ->name('payment-type.')
                            ->controller(\App\Http\Controllers\Accounting\Config\PaymentTypeController::class)
                            ->group(
                                function () {
                                    Route::get('', 'index')->name('index');
                                    Route::get('/create', 'create')->name('create');
...
// ------------------------------------- API (forced wrote these here because there is an issue on api.php) ------------------------------
...
Route::prefix('json')
    ...
    ->group(
        function () {
            Route::get('purchase-order', [\App\Http\Controllers\ApiPurchaseOrderController::class, 'index'])
                ->name('purchase-order');
            Route::get('purchase-order/{purchaseOrderId}/details', [\App\Http\Controllers\ApiPurchaseOrderController::class, 'details'])
                ->name('purchase-order.details');

            Route::get('sales-order', [\App\Http\Controllers\ApiSalesOrderController::class, 'index'])
                ->name('sales-order');
            Route::get('sales-order/{salesOrderId}/details', [\App\Http\Controllers\ApiSalesOrderController::class, 'details'])
                ->name('sales-order.details');

            Route::get('sales-order-detail', [\App\Http\Controllers\ApiSalesOrderDetailController::class, 'index'])
                ->name('sales-order-detail');
            Route::get('sales-order-detail/{salesOrderDetailId}', [\App\Http\Controllers\ApiSalesOrderDetailController::class, 'show'])
                ->name('sales-order-detail.show');
        }
    );
...
Route::prefix('json')
    ...
    ->group(
        function () {
            Route::post('gps-record', [\App\Http\Controllers\ApiTmsGpsController::class, 'store']);
        }
    );
